    ...
    return(
        <div>
            ...
            <div className="flex flex-col  justify-center items-center ">
                ...
                <a className="py-4" href="https://linkedin.com/in/sidhesh-bankar-97b484252" target="_blank">
                ...
                <a className="py-4" href="https://github.com/Sidhesh-02" target="_blank">
                    <svg className="w-7 h-7 text-gray-400 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a className="py-4" href="https://www.instagram.com/_sid.02" target="_blank">
                ...
                <a className="py-4" href="https://www.youtube.com/channel/UCTXmxuNq8e-b6s4grt241zQ" target="_blank">
                    <svg className="w-7 h-7 text-gray-400 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
